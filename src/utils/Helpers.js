...
export const adminId = ["106578176804406122675"];
...
export const TemplatesData = [
  { id: `template-${Date.now()}`, name: "Template 1", component: Template1 },
  { id: `template-${Date.now()}`, name: "Template 2", component: Template2 },
];
